...
export default function Create({ kategoriList, statusList }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('admin.program-kegiatan.store'), {
            forceFormData: true,
        });
    };
    ...
    return (
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-gray-600 mt-1">
                            Isi formulir di bawah ini untuk menambahkan agenda atau publikasi baru.
                        </p>
                    </div>
                    <Link
        ...
        >
            <Head title="Buat Program & Kegiatan - Admin" />
            ...
            <div className="max-w-4xl mx-auto">
                <form onSubmit={handleSubmit} className="card-residential p-6 sm:p-8 space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div className="sm:col-span-2">
                            ...
                            <input
                                ...
                                placeholder="Contoh: Kerja Bakti Bersih Lingkungan & Drainase"
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input
                                ...
                                placeholder="Contoh: Bpk. Jajang / Ibu Aminah"
                                className="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
                            />
                            {errors.pic_nama && (
                    ...
                    <div className="border-t border-gray-100 pt-6">
                        ...
                        <p className="text-xs text-gray-500">Unggah e-flyer agar informasi kepada warga lebih komunikatif.</p>
                    </div>
                    ...
                    <div className="space-y-5">
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="Tuliskan keterangan lengkap kegiatan, perlengkapan yang harus dibawa, atau tata tertib acara..."
                                className="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
                            />
                            {errors.deskripsi && (
                        ...
                        <div>
                            <label className="block text-xs font-bold text-gray-700 uppercase mb-1">
                                Unggah e-Flyer / Poster (Maks. 2MB, JPG/PNG)
                            </label>
                            <input
                                type="file"
                                accept="image/*"
                            ...
                            {preview && (
                                <div className="mt-4 p-3 bg-gray-50 rounded-2xl border border-gray-200 inline-block">
                                    <p className="text-xs font-bold text-gray-600 mb-2">Pratinjau e-Flyer:</p>
                    ...
                    <div className="border-t border-gray-100 pt-6 flex justify-end gap-3">
                        ...
                        >
                            {processing ? 'Menyimpan...' : 'Simpan Program & Kegiatan'}
                        </button>
                    </div>
                </form>
            </div>
