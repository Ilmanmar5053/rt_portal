...
export default function Create({ wargas }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        kategori: 'Fasilitas',
        is_anonim: false,
        status_progres: 'Diajukan',
    });

    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('admin.pengaduan.store'));
    };

    return (
        <AdminLayout
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Tambah Pengaduan Warga</h2>}
        >
