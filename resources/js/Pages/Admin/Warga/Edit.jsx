...
export default function Edit({ warga, keluargas }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        status_hubungan_keluarga: warga.status_hubungan_keluarga || 'Anak',
        kewarganegaraan: warga.kewarganegaraan || 'WNI',
        nama_ayah: warga.nama_ayah || '',
        nama_ibu: warga.nama_ibu || '',
        no_hp: warga.no_hp || '',
        status_hidup: warga.status_hidup || 'Hidup',
        buat_akun: warga.user ? true : false,
        email: warga.user ? warga.user.email : '',
        generate_iuran: [],
    });
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route('admin.warga.update', warga.id));
    };
    ...
    return (
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        <h2 className="text-xl font-bold leading-tight text-slate-800">
                            Ubah Data Anggota Warga
                        </h2>
                        <p className="text-xs text-slate-500 mt-1 font-medium">
                            Perbarui informasi kependudukan untuk <span className="font-semibold text-slate-700">{warga.nama_lengkap}</span> (NIK: {warga.nik})
                        </p>
                    </div>
                    <Link
        ...
        >
            <Head title={`Edit Warga - ${warga.nama_lengkap}`} />
                ...
                <div className="mx-auto max-w-4xl">
                    <form onSubmit={submit}>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <TextInput
                                        ...
                                        name="nik"
                                        value={data.nik}
                                        className="mt-1 block w-full bg-slate-100 font-mono text-slate-600 cursor-not-allowed"
                                        onChange={(e) => setData('nik', e.target.value)}
                                        required
                                        readOnly
                                    />
                                    <p className="text-xs text-slate-500 mt-1">NIK bersifat unik dan tidak dapat diubah setelah pendaftaran.</p>
                        ...
                        <FormSection
                            ...
                            description="Tautkan atau perbarui kredensial akun untuk login ke portal warga mandiri."
                            color="slate"
                            icon={
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                                ...
                                <label className="flex items-center gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200/80 cursor-pointer hover:bg-slate-100/70 transition">
                                    ...
                                    <div>
                                        <span className="text-sm font-bold text-slate-800">
                                            Aktifkan / Perbarui Akun Login untuk Warga Ini
                                        </span>
                        ...
                        <FormSection
                            ...
                            description="Centang jenis iuran yang ingin langsung dibuat tagihannya saat memperbarui data warga ini."
                            color="purple"
                            icon={
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
