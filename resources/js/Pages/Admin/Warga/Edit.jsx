...
export default function Edit({ warga, keluargas }) {
    ...
    return (
        <AdminLayout
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Ubah Data Anggota Keluarga (Warga)</h2>}
        >
            <Head title="Edit Warga" />
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <TextInput
                                        ...
                                        readOnly
                                    />
                                    <p className="text-xs text-gray-500 mt-1">NIK tidak dapat diubah (Unik).</p>
                            ...
                            <div className="pt-4 border-t border-gray-100">
                                <div className="flex items-center mb-4">
                                    ...
                                    <label htmlFor="buat_akun" className="ms-2 text-sm font-medium text-gray-900">
                                        Perbarui Akun Login untuk warga ini (Terkoneksi ke sistem portal warga)
                                    </label>
                                </div>
                                {data.buat_akun && (
                                    <div className="mb-4">
                                        ...
                                        {!warga.user && (
                                            <p className="mt-1 text-xs text-gray-500">Password default akan menggunakan NIK.</p>
                                        )}
                                    </div>
                                )}
                            </div>
