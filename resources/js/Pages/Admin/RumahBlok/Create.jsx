...
export default function Create() {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('admin.rumah.store'));
    };

    return (
        <AdminLayout header="Tambah Master Rumah">
                    ...
                    <div className="grid grid-cols-1 gap-6">
                        ...
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                            <p className="text-sm text-blue-700 flex items-start gap-2">
                                ...
                                <span><strong>Info:</strong> Status hunian akan diatur otomatis oleh sistem. Rumah akan menjadi "Diisi" jika ada Data KK yang terdaftar pada blok rumah ini, dan "Kosong" jika tidak ada KK.</span>
                            </p>
                        </div>
